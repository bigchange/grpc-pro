...
public class FileContentUtil {
   ...
   * @throws Exception
   */
  public static void readFiles(String dir, List<String> list) throws Exception {
   ...
   * @throws Exception
   */
  public static void saveFile(String fileSave, List<String> lines) throws Exception {
